...
- We maken wat ruimte in het midden van het lokaal
- We definieren de vier hoeken van het lokaal met verschillende datatypen: Boolean, Integer, String en Float
- De docent noemt een waarde op en jullie lopen snel naar de juiste hoek voor het passende datatype
