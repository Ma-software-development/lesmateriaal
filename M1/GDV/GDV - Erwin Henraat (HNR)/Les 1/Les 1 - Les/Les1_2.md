...
Welke stappen zitten daar in? Welke instructies geef je iemand die dat nog nooit heeft gedaan?

![pancake](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExbWxsbDR1cHB1cjNseDNzbG1wd204enlkY2NzbXVtOG1xczBmeHc3ciZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/CORSoBp4cpxHvZQ56c/giphy.gif)
...
## klassiekale Oefening: De Robot (15 min)

- Maak 2 of 3 tallen
- Verdeel de rollen
  - 1 robot
  - 1 of 2 instructeurs
- De instructeurs kiezen voor de robot 1 van de volgende geheime doelen:

<details>

- De lift instappen en de deur sluiten
- 1 verdieping naar beneden lopen met de trap
- De toilet inlopen en doorspoelen
- kloppen op de deur van de docentenkamer

</details>

Ga met je robot naar de gang en geef instructies die zo klein mogelijk zijn zoals: 'Til je rechterarm tot schouderhoogte'

'loop naar voren' of 'maak de deur open' zijn niet toegestaan.

De robot moet dan een **error** geven!

Probeer met je robot in een kwartier de opdracht uit te voeren.

![quop](https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExdGs4eDR2a2t0ODZtcW1oNGJ3bWpvbGl4Nmpib2w5M21tYnlwMjZ5aCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/1ecijSSplLBSw/giphy.gif)
...
## Je Eerste Script Maken in Unity

We gaan nu instructies geven aan Unity in plaats van aan een robot.

Hiervoor hebben we een script nodig. Unity maakt hiervoor gebruik van **.cs** bestanden.

Dit staat voor **C-Sharp** ook wel geschreven als **C#**

Dit is de codetaal die we kunnen gebruiken in Unity.

In het .cs bestand zet de de instructies voor Unity en dus voor je game.

Voer nu samen met mij deze stappen uit. (Je hebt hier een bestaand Unity project voor nodig)
